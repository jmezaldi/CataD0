...
public class AreaController implements Serializable {
	...
	@EJB
	private com.yanbal.catalogo.ejb.AreaFacade ejbFacade;
	@EJB
	...
	public DataModel getItems() {
		if (items == null) {
			...
			filteredArea = new ArrayList<Area>(ejbFacade.findAll());
	...
	public static class AreaControllerConverter implements Converter {
		...
		public Object getAsObject(FacesContext facesContext,
			...
			AreaController controller = (AreaController) facesContext
					.getApplication()
					.getELResolver()
	...
	public String prepareEditCust(Area obj) {
		current = obj;
		selectedItemIndex = pagination.getPageFirstItem()
				+ getItems().getRowIndex();
		return "Edit";
	...
	public String destroyCust(Area obj) {
