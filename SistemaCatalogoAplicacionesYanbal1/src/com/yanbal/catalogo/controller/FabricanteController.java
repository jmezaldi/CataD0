...
public class FabricanteController implements Serializable {
	...
	@EJB
	private com.yanbal.catalogo.ejb.FabricanteFacade ejbFacade;
	@EJB
	private com.yanbal.catalogo.ejb.UsuarioFacade ejbFacadeUsuario;
	private PaginationHelper pagination;
	private int selectedItemIndex;

	private List<Fabricante> filteredFabricante;
	...
	public DataModel getItems() {
		if (items == null) {
			...
			filteredFabricante = new ArrayList<Fabricante>(ejbFacade.findAll());
	...
	public static class FabricanteControllerConverter implements Converter {
		...
		public Object getAsObject(FacesContext facesContext,
			...
			FabricanteController controller = (FabricanteController) facesContext
					.getApplication()
					.getELResolver()
		...
		public String getAsString(FacesContext facesContext,
			...
			if (object instanceof Fabricante) {
				...
				throw new IllegalArgumentException("object " + object
						...
						+ "; expected type: "
						+ FabricanteController.class.getName());
			}
		}
	}

	public String prepareEditCust(Fabricante obj) {
		current = obj;
		selectedItemIndex = pagination.getPageFirstItem()
				+ getItems().getRowIndex();
		return "Edit";
	...
	public String destroyCust(Fabricante obj) {
	...
	public List<Fabricante> getFilteredFabricante() {
		return filteredFabricante;
	}

	public void setFilteredFabricante(List<Fabricante> filteredFabricante) {
		this.filteredFabricante = filteredFabricante;
	}
